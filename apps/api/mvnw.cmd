...
if exist "%WRAPPER_JAR%" (
  rem Ensure Maven sees the multi-module project directory to avoid warning
  rem append a dot to avoid trailing-backslash escaping the quote
...
echo If you have Maven installed, generate the wrapper with:
echo   mvn -N io.takari:maven:wrapper -Dmaven=3.9.15
exit /b 1
<# : batch portion
@REM ----------------------------------------------------------------------------
